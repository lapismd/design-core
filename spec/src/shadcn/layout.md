...
- WebKit fallback coverage MUST prove vertical wheel and programmatic scrolling, absence of nonfunctional custom scrollbar parts and Bits viewport attributes, a transparent borderless native rail, and bounded direct and imperative-host layouts without relying on visual scrollbar paint.
- The catalog MUST demonstrate the family’s supported states without introducing a second runtime contract.
