...
- Shared explorer row tokens MUST default selected fill to the same wash as row hover, and the default indent MUST place nested guides under expanded disclosure chevron tips.
