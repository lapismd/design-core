...
- The catalog MUST demonstrate one-way, three-way, editable, MisMerge-style solid insert/reject arrows that match line-number color and size, syntax-highlighted Changeyard fixtures, comparison-option, and connector-band states without introducing a second runtime contract.
