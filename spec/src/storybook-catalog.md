...
- Browser-test dependencies that Vite discovers through editor stories MUST be prebundled before the suite starts so a cold run cannot invalidate active tests with a dependency-optimization reload.
