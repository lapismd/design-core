...
- Shared Form tokens MUST retain the existing subtle sortable-row focus paint and transparent remove-action hover paint as defaults while allowing ancestor overrides for both.
