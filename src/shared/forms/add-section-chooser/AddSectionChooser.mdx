...
<Source language="html" code={"<AddSectionChooser\n  open={open}\n  title={title}\n  options={[{ value: \"experience\", label: \"Experience\" }]}\n  onOpen={...}\n  onCancel={...}\n  onTitleChange={...}\n  onChoose={...}\n/>"} />
...
Colocated CSS: `AddSectionChooser.css`. Paint with package tokens from
...
<Canvas of={AddSectionChooserVariations.Closed} meta={AddSectionChooserVariations} />

### Open chooser

Title field + type chips after opening add.

<Canvas of={AddSectionChooserVariations.OpenChooser} meta={AddSectionChooserVariations} />
