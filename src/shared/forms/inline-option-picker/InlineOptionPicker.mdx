...
<Source language="html" code={"<InlineOptionPicker\n  value={status}\n  options={[{ value: \"draft\", label: \"Draft\" }, { value: \"published\", label: \"Published\" }]}\n  presentation=\"menu\"\n  onChange={...}\n/>"} />
...
<Canvas of={InlineOptionPickerVariations.Menu} meta={InlineOptionPickerVariations} />

### Swap

Swap presentation for cycling values.

<Canvas of={InlineOptionPickerVariations.Swap} meta={InlineOptionPickerVariations} />
