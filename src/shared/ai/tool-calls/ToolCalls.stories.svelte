...
<Story
  ...
  parameters={{
    visualDelta: {
      images: ["/visual-baselines/ai/tool-calls/astryx-showcase-chromium.png"],
      opacity: 0.5,
...
<Story
  ...
  parameters={{
    ...
    visualDelta: {
      images: ["/visual-baselines/ai/tool-calls/statuses-chromium.png"],
      opacity: 0.5,
      colorInversion: false,
      align: "canvas",
      placement: "right",
...
<Story
  ...
  parameters={{
    ...
    visualDelta: {
      images: ["/visual-baselines/ai/tool-calls/simple-chromium.png"],
      opacity: 0.5,
      colorInversion: false,
      align: "canvas",
      placement: "right",
...
<Story
  ...
  parameters={{
    ...
    visualDelta: {
      images: ["/visual-baselines/ai/tool-calls/expandable-chromium.png"],
      opacity: 0.5,
      colorInversion: false,
      align: "canvas",
      placement: "right",
