...
const LAYOUT_CONTEXT = Symbol.for("@stevejuma/ui/ai/chat/layout");
const COMPOSER_CONTEXT = Symbol.for("@stevejuma/ui/ai/chat/composer");
const LIST_CONTEXT = Symbol.for("@stevejuma/ui/ai/chat/list");
const MESSAGE_CONTEXT = Symbol.for("@stevejuma/ui/ai/chat/message");
