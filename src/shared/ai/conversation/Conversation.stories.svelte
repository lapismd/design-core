<script module lang="ts">
  ...
  import ToolCalls from "../tool-calls/ToolCalls.svelte";
  import ReactionBar from "../experimental/reaction-bar/ReactionBar.svelte";
  import Reasoning from "../experimental/reasoning/Reasoning.svelte";
  import TypingIndicator from "../experimental/typing-indicator/TypingIndicator.svelte";
  import UnreadDivider from "../experimental/unread-divider/UnreadDivider.svelte";
...
<Story
  ...
  parameters={{
    visualDelta: {
      images: [
        "/visual-baselines/ai/conversation/complete-ai-conversation-chromium-darwin.png",
      ],
      opacity: 0.5,
