...
<style>
  ...
  :global {
    ...
    @layer utilities {
      ...
      [data-ui-component="dialog"][data-ui-part="dialog-footer"],
      [data-ui-component="dialog"][data-ui-part="dialog-header"] {
        display: flex;
      }
      [data-ui-component="dialog"][data-ui-part="dialog-content"] {
        display: grid;
      ...
      [data-ui-component="dialog"][data-ui-part="dialog-title"] {
        --tw-leading: 1;
        line-height: 1;
      }
      [data-ui-component="dialog"][data-ui-part="dialog-title"] {
      ...
      [data-ui-component="dialog"][data-ui-part="dialog-content"]:where(
          [data-state="open"]
        ),
      [data-ui-component="dialog"][data-ui-part="dialog-overlay"]:where(
          [data-state="open"]
        ),
      [data-ui-component="dialog"][data-ui-part="dialog-content"]:where(
