...
<Story
  ...
  parameters={{
    visualDelta: {"images":["/visual-baselines/shadcn/dialog/open-custom-close-dialog-chromium-darwin.png"],"opacity":0.5,"colorInversion":false,"align":"canvas","placement":"right","passThresholdPercent":0.1},
  }}
>
  {#snippet template()}
    <div class="p-4">
