...
<style>
  ...
  :global {
    ...
    @layer utilities {
      ...
      [data-ui-component="tooltip"][data-ui-part="tooltip-content-anon-0"][data-side="bottom"] {
      ...
      [data-ui-component="tooltip"][data-ui-part="tooltip-content"][data-side="bottom"] {
        --tw-enter-translate-y: calc(2 * var(--spacing) * -1);
      }
      [data-ui-component="tooltip"][data-ui-part="tooltip-content-anon-0"][data-side="left"] {
        --tw-translate-y: calc(calc(50% - 3px) * -1);
        translate: var(--tw-translate-x) var(--tw-translate-y);
      }
      [data-ui-component="tooltip"][data-ui-part="tooltip-content"][data-side="left"] {
        --tw-enter-translate-x: calc(2 * var(--spacing));
      }
      [data-ui-component="tooltip"][data-ui-part="tooltip-content-anon-0"][data-side="right"] {
      ...
      [data-ui-component="tooltip"][data-ui-part="tooltip-content"][data-side="right"] {
        --tw-enter-translate-x: calc(2 * var(--spacing) * -1);
      }
      [data-ui-component="tooltip"][data-ui-part="tooltip-content-anon-0"][data-side="top"] {
      ...
      [data-ui-component="tooltip"][data-ui-part="tooltip-content"][data-side="top"] {
      ...
      [data-ui-component="tooltip"][data-ui-part="tooltip-content"][data-state="delayed-open"] {
      ...
      [data-ui-component="tooltip"][data-ui-part="tooltip-content"]:where(
          [data-state="open"]
        ),
      [data-ui-component="tooltip"][data-ui-part="tooltip-content"]:where(
