  ...
  const { Story } = defineMeta({
    ...
    parameters: {
      docs: {
        description: {
          component:
            "Inline code element with monospace font and muted background. For fenced multi-line snippets with syntax highlighting, use Code Block. Differs from UI Forms Code Highlighter, which requires a Lezer parser for form previews. See spec/records/code-and-code-block.md and [Shadcn guidance](?path=/docs/shadcn-guidance--docs).",
        },
      },
    },
  });
