...
export const trialBalanceHierarchy = {
  id: "trial-balance",
  label: "Trial Balance",
  color: "var(--ui-beancount-report-trial-treemap)",
  children: [
    {
...
export const trialBalanceNodes = [
  {
    ...
    values: { gbp: "24921.78" },
    weight: "5.3%",
    color: "var(--ui-beancount-report-trial-primary)",
  },
  {
    id: "trial-equity",
  ...
  },
  {
    ...
    values: { gbp: "−213145.48" },
    weight: "45.5%",
    color: "var(--ui-beancount-report-trial-teal)",
  },
];
...
export const trialBalanceContributions = [
  {
    ...
    percentage: 0.0,
    amount: "70.00 GBP",
    color: "var(--ui-beancount-report-trial-cyan)",
  },
  {
    id: "assets-checking",
    label: "Assets:Checking",
  ...
  },
  {
    ...
    percentage: 0.0,
    amount: "111.98 GBP",
    color: "var(--ui-beancount-report-trial-violet)",
  },
  {
    ...
    percentage: 0.2,
    amount: "1132.78 GBP",
    color: "var(--ui-beancount-report-trial-indigo)",
  },
  {
    id: "expenses-joint",
  ...
  },
  {
    ...
    percentage: 0.1,
    amount: "567.68 GBP",
    color: "var(--ui-beancount-report-trial-green)",
  },
  {
    id: "liabilities-loan",
