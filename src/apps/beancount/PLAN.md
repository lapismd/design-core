...
| Journal          | ✅             | 🟡 partial              | Fava date-group cards with separate balance-description and summary-disclosure controls, nested record surfaces that remain visible when their summary is collapsed, posting account identities, timeframe control, record-open callback, controlled pagination/page sizes, cross-page selection scope, and deterministic Upcoming lane complete; align production data adapter and review Visual Delta ≤0.1% |
| Income statement | ✅             | 🟡 partial              | Fava toolbar, unframed historical stacked bars, bottom perspective tabs, and a separate Income hierarchy compose; align production data adapter, chart cadence/colors, and remaining statement sections, then review Visual Delta ≤0.1%.                                                                                                                                                                      |
| Balance sheet    | ✅             | 🟡 partial              | Fava toolbar, unframed net-worth history, bottom perspective tabs, and a separate Assets hierarchy compose; align production data adapter, time-series cadence, liabilities/equity sections, then review Visual Delta ≤0.1%.                                                                                                                                                                                  |
| Trial balance    | ✅             | 🟡 partial              | Fava toolbar, unframed tall treemap, bottom perspective tabs, and a separate contribution ledger compose; align production data adapter, palette, and lower table section, then review Visual Delta ≤0.1%.                                                                                                                                                                                                    |
| Account detail   | ✅             | 🟡 partial              | Fava breadcrumb, stepped balance history and axes, bottom chart-history perspectives, separate account-table tabs, and account-activity fixture complete; align activity density and full account history, then review Visual Delta ≤0.1%                                                                                                                                                                     |
...
| Query            | ✅             | 🟡 partial              | The Fava-reference screen now holds its blank BQL-entry state; the controlled `QueryComposer` story separately proves formatting and execution. Add the production query/history adapter, then review Visual Delta ≤0.1%.                                                                                                                                                                                     |
...
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------- |
| Catalog surface | 71 Beancount components and 58 colocated story modules                                                                                     | Every promoted surface has a display-model contract and a tested story                    |
