...
| Journal          | ✅             | 🟡 partial              | Fava transaction groups, postings, timeframe control, record-open callback, controlled pagination/page sizes, and deterministic Upcoming lane complete; align production data adapter and review Visual Delta ≤0.1% |
