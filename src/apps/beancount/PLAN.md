...
| Sources          | ✅             | 🟡 expanded details     | Fava connected/available source cards, controlled expanded setup/field details, source toolbar, and host callbacks compose. The shared Settings sidebar now selects Bank Sync rather than rendering the ledger-tree fixture; its screen delta is 3.074%. Its interaction test returns to the collapsed, YAML-off reference state before capture; add live sync adapters, then review Visual Delta ≤0.1%.                                                                                                                                                                                                                                                                                                                                                    |
