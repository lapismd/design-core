...
| Import accounts  | ✅ loaded      | 🟡 expanded details     | Fava source-account and unassigned rows, controlled expanded account groups, Sync all, and host actions compose. The shared Settings sidebar now selects Accounts and reduced this screen delta from 1.629% to 1.281%. Its interaction test returns the source card to the collapsed reference state before capture; add production setup adapters, then review Visual Delta ≤0.1%.                                                                                                                                                                                                                                                                                                                                                                         |
