...
| Rules            | ✅ loaded      | 🟡 partial             | Fava rule list, active callback, host menu, and empty history complete; add deterministic runs and production adapters, then review Visual Delta ≤0.1%                                        |
