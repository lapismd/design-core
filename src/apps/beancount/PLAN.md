...
| Query            | ✅             | 🟡 partial              | Fava BQL command bar, host-owned execution and formatting callbacks, and synthetic result-table composition complete; add production query adapter, then review Visual Delta ≤0.1%.                                                                                                                                                                                                                           |
