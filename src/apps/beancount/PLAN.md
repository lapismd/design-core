...
| Journal          | ✅             | 🟡 partial              | Fava date-group cards, nested record surfaces, postings, timeframe control, record-open callback, controlled pagination/page sizes, cross-page selection scope, and deterministic Upcoming lane complete; align production data adapter and review Visual Delta ≤0.1% |
